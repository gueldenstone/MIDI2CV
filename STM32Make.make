...
flash: $(BUILD_DIR)/$(TARGET).elf
	openocd -f interface/stlink-v2-1.cfg  -f target/stm32f0x.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	openocd -f interface/stlink-v2-1.cfg -f target/stm32f0x.cfg -c "init; reset halt;  mass_erase 0; exit"
